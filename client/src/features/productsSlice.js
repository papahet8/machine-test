...
const BASE_URL =
    import.meta.env.MODE === 'development'
        ? '/api'
        : 'https://machine-test-t6v8.onrender.com/api';
...
const productsSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(fetchTopReviewed.rejected, (state, action) => {
                state.chartsError = action.payload;
            })

            // Discount distribution
            .addCase(fetchDiscountDistribution.fulfilled, (state, action) => {
                state.discountDistribution = action.payload;
            })
            ...
            // Category avg rating
            .addCase(fetchCategoryAvgRating.fulfilled, (state, action) => {
                state.categoryAvgRating = action.payload;
            })
            .addCase(fetchCategoryAvgRating.rejected, (state, action) => {
                state.chartsError = action.payload;
            })
